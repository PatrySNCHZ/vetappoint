...
INSERT INTO mascotas (id_mascota, id_usuario, foto, nombre, especie, edad, raza, descripcion, chip, genero) VALUES (1, 2, 'https://pbs.twimg.com/media/FS5PnB7WYAEfEos?format=jpg&name=large', 'Vane', 'perro', 3, 'chucho', 'enano', '724111111111111', 'Hembra');
INSERT INTO mascotas (id_mascota, id_usuario, foto, nombre, especie, edad, raza, descripcion, chip, genero) VALUES (2, 1, 'https://pbs.twimg.com/media/FS5PnB7WYAEfEos?format=jpg&name=large', 'Vane', 'perro', 3, 'chucho', 'enano', '724111111111112', 'Hembra');
INSERT INTO mascotas (id_mascota, id_usuario, foto, nombre, especie, edad, raza, descripcion, chip, genero) VALUES (3, 2, 'https://pbs.twimg.com/media/FS5PnB7WYAEfEos?format=jpg&name=large', 'Vane', 'perro', 3, 'chucho', 'enano', '724111111111113', 'Hembra');
INSERT INTO mascotas (id_mascota, id_usuario, foto, nombre, especie, edad, raza, descripcion, chip, genero) VALUES (4, 2, 'https://pbs.twimg.com/media/FS5PnB7WYAEfEos?format=jpg&name=large', 'Vane', 'perro', 3, 'chucho', 'enano', '724111111111114', 'Hembra');
...
INSERT INTO clinicas(id_clinica, nombre, direccion1, direccion2, localidad, provincia, cp, tlf1, tlf2, tlf_urgencia, cif, email,  clave, horario, granularidad ) VALUES (2, 'vet almeria', 'calle roduela', '3', 'Mijas', 'Málaga', '11134', '69584858', '57848545', '65858545', 'B123123123','vdlr1@vet.com',  'abc1234', 'L-V 8:00-14:00','30');
INSERT INTO clinicas(id_clinica, nombre, direccion1, direccion2, localidad, provincia, cp, tlf1, tlf2, tlf_urgencia, cif, email,  clave, horario, granularidad ) VALUES (3, 'veterinaria S. Fernando', 'calle roduela', '3', 'San Fernando', 'Cádiz', '11134', '69584858', '57848545', '65858545', 'B123123123','vdlr2@vet.com',  'abc1234', 'L-V 8:00-14:00','30');
INSERT INTO clinicas(id_clinica, nombre, direccion1, direccion2, localidad, provincia, cp, tlf1, tlf2, tlf_urgencia, cif, email,  clave, horario, granularidad ) VALUES (4, 'veterinaria 2 Hmanas.', 'calle roduela', '3', '2 Hermanas', 'Sevilla', '11134', '69584858', '57848545', '65858545', 'B123123123','vdlr2@vet.com',  'abc1234', 'L-V 8:00-14:00','30');
INSERT INTO clinicas(id_clinica, nombre, direccion1, direccion2, localidad, provincia, cp, tlf1, tlf2, tlf_urgencia, cif, email,  clave, horario, granularidad ) VALUES (5, 'veterinaria P. Umbría', 'calle roduela', '3', 'Punta Umbría', 'Huelva', '11134', '69584858', '57848545', '65858545', 'B123123123','vdlr2@vet.com',  'abc1234', 'L-V 8:00-14:00','30');
INSERT INTO clinicas(id_clinica, nombre, direccion1, direccion2, localidad, provincia, cp, tlf1, tlf2, tlf_urgencia, cif, email,  clave, horario, granularidad ) VALUES (6, 'veterinaria Chiclana', 'calle roduela', '3', 'Chiclana', 'Cádiz', '11134', '69584858', '57848545', '65858545', 'B123123123','vdlr2@vet.com',  'abc1234', 'L-V 8:00-14:00','30');
